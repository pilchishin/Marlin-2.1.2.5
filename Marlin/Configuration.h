...
#define STRING_CONFIG_H_AUTHOR "(Marlin, 2.1.2.5)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 5120, 832.6 } // ПЕРЕМЕШЕНИЕ ШАГОВ НА ММ, НУЖНО ПОМЕНЯТЬ
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 4, 50 } //  МАКСИМАЛЬНЫЕ СКОРОСТИ ПО ОСЯМ
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 10000 } //максимальные ускорения по осям
 ...
 */
#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration for printing moves, ускорение при печати
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts, ускорение на ретракте
#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration for travel (non printing) moves, ускорение холостого хода
...
// The size of the printable area область печати
#define X_BED_SIZE 200
#define Y_BED_SIZE 200

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions. лимиты перемещения по осям
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
